...
export const Header = () => {
    ...
    const [loggedUser, setLoggedUser] = useState<UserDto | null>(user);
                ...
                <div className="relative sign-in flex justify-end items-center gap-3">
                    ...
                    <div
                        ...
                        <p className="mb-2 text-lg font-semibold tracking-tight text-gray-900 dark:text-white">
                            {loggedUser?.name}Shehan Rathnayake
                        </p>
                        <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
                            {loggedUser?.email}shehandj.swd@gmail.com
                        </p>
                        <a href="#"
                    ...
                    <button type="button" onClick={onHandleRegisterBtnClick}
                            className={`${loggedUser ? 'hidden' : 'block'} text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center`}>
                        Register
                    </button>
                </div>
            </div>
